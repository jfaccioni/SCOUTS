...
* GitHub stand-alone repository
* binary executable (experimental)
...
Make sure you have **Python >= 3.6** installed in your system. Check this by opening a terminal and typing:
...
#### Download and run as an executable binary
