...
A full list of the third-party packages (and their dependencies) in a known working environment are listed in the `environment.yml <https://github.com/jfaccioni/scout/environment.yml>`_ file (tested in Ubuntu 18.04).
